FELIX_VERSION := $(shell cat FELIX_VERSION)
FELIX_DEPS := $(wildcard FELIX_*)
DOCKER_TAG_PREFIX := rzuckerm/felix:$(FELIX_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(FELIX_DEPS)
